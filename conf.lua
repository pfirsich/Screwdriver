function love.conf(t)
	...
	t.identity = "Screwdriver"               -- The name of the save directory (string)
	t.version = "0.9.2"                -- The LÖVE version this game was made for (string)
	t.console = true                  -- Attach a console (boolean, Windows only)

	t.window.title = "Screwdriver"       -- The window title (string)
	...
	-- Remove unneeded modules in release version
