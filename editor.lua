do
	...
	function editor.snapMouseToGrid()
		local spacing = components["Core"].static.gridSpacing
		local mouseWorldPosX, mouseWorldPosY = camera.screenToWorld(love.mouse.getPosition())
		local offsetX = math.floor(mouseWorldPosX / spacing - math.floor(mouseWorldPosX / spacing) + 0.5)
		local offsetY = math.floor(mouseWorldPosY / spacing - math.floor(mouseWorldPosY / spacing) + 0.5)
		mouseWorldPosX = spacing * (math.floor(mouseWorldPosX / spacing) + offsetX)
		mouseWorldPosY = spacing * (math.floor(mouseWorldPosY / spacing) + offsetY)
		love.mouse.setPosition(camera.worldToScreen(mouseWorldPosX, mouseWorldPosY))
	end
